    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div id="filters" class="mt-1 ml-1">
                        ...
                        <select id="typeValuesExport" class="selectpicker" multiple data-live-search="true" ></select>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="exportFile(true)"></span> Ics export</button>
                <button type="button" id="submitButtonExport" class="btn btn-success" onclick="exportFile(false)"></span> Json export</button>
            </div>
        </div>
    </div>
</div>
